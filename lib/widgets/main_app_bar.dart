               ...
               decoration: InputDecoration(
                    ...
                    // suffixIconConstraints: BoxConstraints(maxHeight: 18),
                     suffix: Transform.translate(
                      offset: Offset(-5,5),
                       child: GestureDetector(child: Icon(Icons.close, size: 20,), onTap: (){
             ...
             return  _searchProducts(pattern);
              ...
              itemBuilder: (context, Product suggestion) {
               ...
               return ListTile(
                 ...
                 title: Row(
                   children: [
                    Image.network(suggestion.image[0], width: 40,height: 40,),
                    SizedBox(width: 6,),
                     Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                       children: [
                         Text(suggestion.name),
                         Text("\$${suggestion.price}", style: TextStyle(color: Colors.grey, fontSize: 12),),
                       ],
                     ),
                   ],
                 ),
